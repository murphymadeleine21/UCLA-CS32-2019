...
bool pathExists(char maze[][10], int sr, int sc, int er, int ec)
{
    ...
    while (!coords.empty())
    {
        Coord current = coords.front();       //put coordinates into a new current coord
        ...
        {
            Coord s(r+1, c);
            coords.push(s);                     //push coordinate onto queue
        ...
        {
            Coord w(r, c-1);
            coords.push(w);                     //push coordinate onto queue
        ...
        {
            Coord n(r-1, c);
            coords.push(n);                     //push coordinate onto queue
            maze[r-1][c] = 'E';                 //update maze
        }
        ...
        {
            Coord e(r, c+1);
            coords.push(e);                     //push coordinate onto queue
            maze[r][c+1] = 'E';                 //update maze
        }
