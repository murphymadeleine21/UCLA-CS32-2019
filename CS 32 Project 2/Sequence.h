...
private:
    ...
    void addItem(int pos, const ItemType& value); // Insert value at position pos, making a new node in the middle
    void addToFront(const ItemType& value);        //will these even take a position? check before maybe
