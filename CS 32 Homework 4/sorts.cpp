...
int main()
{
    ...
    // destruction time.
    {
        ...
        //        order.
        for (int i = 0; i < corrSensors.size(); i++)
            sensors[i] = *corrSensors[i];
